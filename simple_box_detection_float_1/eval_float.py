...
VALUE = 1
hidden_size = 40
Checkpoint_Destination = './save_model_2/2200207_episode_1999.pth'

def log(logstr):
    file_name = os.path.join('./save_model_2/', '220208_eval.log')
...
class Continuous_A2C(
    nn.Module):  # https://medium.com/deeplearningmadeeasy/advantage-actor-critic-continuous-case-implementation-f55ce5da6b4c
...
class A2CAgent:
    def __init__(self, action_size, state_size, max_action,checkpoint=True):
        self.render = True
    ...
    def get_action(self, state):
        ...
        dist = torch.distributions.Normal(loc=mu,
                                          scale=sigma)  # https://pytorch.org/docs/stable/distributions.html#torch.distributions.normal.Normal
