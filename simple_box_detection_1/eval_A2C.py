...
VALUE = 1
hidden_size = 40
Checkpoint_Destination='D:\\Users\\hyPark\\Desktop\\A2C_ObjectDetection\\simple_box_detection_1\\save_model2\\220127_episode_25.pth'

def log(logstr):
    file_name = os.path.join('./save_model_eval/', '220207_final2.log')
...
class A2CAgent:
    def __init__(self, action_size, state_size, checkpoint=False):
        self.render = True
...
if __name__ == "__main__":
    ...
    agent = A2CAgent(action_size, state_size, checkpoint=True)
