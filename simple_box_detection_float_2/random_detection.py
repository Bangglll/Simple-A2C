...
class Env(tk.Tk):
    ...
    def get_state(self): #
        ...
        states.append(agent_x1 - gt_box_coord[0])
        states.append(agent_y1 - gt_box_coord[1])
        states.append(agent_x2 - gt_box_coord[2])
        states.append( agent_y2 - gt_box_coord[3])
    ...
    def move_rect(self, action,idx):
        ...
        # if s[0] + action[0] - 1 > 10 and s[2] + action[2] < WIDTH*UNIT - 1 and (s[2]+ action[2]) - (s[0] + action[0]) > 10 :
        if s[0] + action[0] - 1 > 5 and s[2] + action[2] < WIDTH*UNIT - 1 and (s[2] + action[2]) - (s[0] + action[0]) > 5:
            x1 = action[0] + x1
        # if s[1] + action[1] - 1 > 10 and s[3] + action[3] < HEIGHT*UNIT - 1 and (s[3]+ action[3]) - (s[1] + action[1]) > 10:
        if s[1] + action[1] - 1 > 5 and s[3] + action[3] < HEIGHT*UNIT - 1 and (s[3] + action[3]) - (s[1] + action[1]) > 5:
            y1 = action[1] + y1
        # if s[0] + action[0] - 1 > 10 and s[2] + action[2] < WIDTH*UNIT - 1 and (s[2]+ action[2]) - (s[0] + action[0]) > 10:
        if s[0] + action[0] - 1 > 5 and s[2] + action[2] < WIDTH*UNIT - 1 and (s[2] + action[2]) - (s[0] + action[0]) > 5:
            x2 = action[2] + x2
